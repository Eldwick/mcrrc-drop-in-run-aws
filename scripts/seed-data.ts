// TODO: Adapt for DynamoDB seeding via scripts/seed-dynamodb.ts
// Edit tokens will be generated at write time (crypto.randomUUID()).
...
export const seedRuns = [
  ...
  },
  {
    ...
    startTime: "7:00 PM",
    locationName:
      "Montgomery Blair HS Track (51 University Blvd E, Silver Spring)",
    latitude: 39.0147,
    longitude: -77.0096,
    typicalDistances: "Track intervals",
    terrain: "Road",
  ...
  },
  {
    ...
    startTime: "5:30 AM",
    locationName:
      "Millennium Trail, Fallsgrove (Seven Locks Rd, Rockville)",
    latitude: 39.1007,
    longitude: -77.1933,
  ...
  },
  {
    ...
    startTime: "5:30 AM",
    locationName:
      "Kemp Mill Shopping Center (1370 Lamberton Dr, Silver Spring)",
    latitude: 39.0423,
    longitude: -77.0187,
    typicalDistances: "4\u20136 miles",
    terrain: "Road",
  ...
  },
  {
    ...
    startTime: "6:30 PM",
    locationName:
      "BabyCat Bethesda Taproom (10241 Kensington Pkwy, Kensington)",
    latitude: 39.0221,
    longitude: -77.0733,
